  ...
  const handleSuggestion = (value: string) => {
    if (topics) {
      const tempArr = topics.filter((topic_name, _) => {
        if (topic_name.toLowerCase().includes(value.toLowerCase())) {
          return topic_name
        }
        return
      })
    ...
    >
      ...
      <AnimatePresence>
        {menuPressed && (
          ...
          >
            {bottom_navbar_items.map((navbar_item, nav_index) => {
              return (
                <div
                  ...
                  className="h-[55px] 
                                        ...
                                        "
                  onClick={() => {
                    handleNavigation(navbar_item, 'Topic 1')
            ...
            >
              ...
              >
                {auth.currentUser?.email || isLoggedInUser ? null : (
                  <FontAwesomeIcon
                    icon={faChevronLeft}
              ...
              >
                <div
                  ...
                  onClick={() => {
                    setMenuPressed(false)
                    if (auth.currentUser?.email || isLoggedInUser) {
                      onPressLogout()
                    } else {
                ...
                >
                  <p
                    className="text-[.8rem] text-black hover:underline
                                    ...
                                    "
                  >
                    {auth.currentUser?.email || isLoggedInUser
                      ? 'Logout'
                      : 'Register'}
                  </p>
                </div>
      ...
      >
        ...
        >
              ...
              onKeyDown={(
                ...
                if (e.key === 'Enter') {
                  ...
                  const formattedTopicName =
                    getFormattedTopicName(searchText)
                  router.push(`/search/maths/${formattedTopicName}`)
          ...
          {showSuggestions && (
            ...
            >
              ...
              <div className="mt-3">
                {suggestions.map((suggestion, sugg_index) => {
                  return (
                    <div
              ...
              >
                <p className="text-xs text-gray-700 font-normal">
                  Search all resources for "{searchText}"
                </p>
              </div>
            </motion.div>
          )}
        ...
        >
          ...
          >
            <p className="text-xs font-semibold">Workbook Store</p>
          </div>
        </div>
      </div>
      ...
      >
          ...
          {bottom_navbar_items.map((item, ind) => {
            return (
              ...
              >
                ...
                {showMinimizedLinkDropdown === item && (
                  <motion.div
                    initial={{
                      scale: 0,
                      y: 15,
                  ...
                  >
                    <div
                      className="w-[170px] bg-white shadow-md
                                            ...
                                            "
                    >
                      {nav_menu_list.map((nav_item, nav_ind) => {
                        return (
                          <div
                            ...
                            onClick={() => {
                              if (item !== 'Browse by topic') {
                                if (nav_item !== 'See All') {
                                  setShowMinimizedLinkDropdown('')
                                  handleNavigation(item, nav_item)
                                }
                              }
                            }}
                            onMouseEnter={() => {
        ...
        >
          ...
          >
            <p className="text-xs font-semibold">Become a Member</p>
                ...
                >
                  ...
                  <span
                    className="no-underline w-full
                                    ...
                                    "
                  >
                    {isLoggedIn === true || isLoggedInUser
                      ? null
                      : '2.'}
                    <Link
                      onClick={() => {}}
